...
class WebPages::Loto6 < WebPage
  ...
  THEAD_CSS_SELECTOR = "#{TABLE_CSS_SELECTOR} thead"
  TBODY_CSS_SELECTOR = "#{TABLE_CSS_SELECTOR} tbody"
  ...
  def numbers
    driver.find_elements(:css, "#{TBODY_CSS_SELECTOR} tr:nth-child(2) td strong").map { | element | element.text }
  end
